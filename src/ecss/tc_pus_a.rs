//! This module contains all components required to create a ECSS PUS A legacy telecommand.
//!
//! # Examples
//!
//! ```rust
...
mod tests {
    ...
    fn test_deserialization() {
        ...
        assert_eq!(tc_from_raw.total_len(), 11);
    ...
    fn test_deserialization_with_app_data() {
        ...
        let tc_from_raw = PusTcReader::new(&test_buf, None, 0)
            .expect("Creating PUS TC struct from raw buffer failed");
        assert_eq!(tc_from_raw.total_len(), 14);
    ...
    fn verify_test_tc_generic(tc: &(impl PusPacket + GenericPusTcSecondaryHeader)) {
        ...
        assert_eq!(PusPacket::pus_version(tc), PusVersion::PusA);
